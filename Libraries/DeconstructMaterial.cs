...
namespace BuildSystemsGH.Libraries
{
    public class DeconstructMaterial : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Conversion factor", "Factor", "Material conversion factor to get to m3", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(4, new GH_Number(material.ConversionFactor));
            DA.SetData(5, new GH_Number(material.PENRT_A1ToA3));
            DA.SetData(6, new GH_Number(material.PENRT_C3));
            DA.SetData(7, new GH_Number(material.PENRT_C4));
            DA.SetData(8, new GH_Number(material.PENRT_D1));
            DA.SetData(9, new GH_Number(material.GWP_A1ToA3));
            DA.SetData(10, new GH_Number(material.GWP_C3));
            DA.SetData(11, new GH_Number(material.GWP_C4));
            DA.SetData(12, new GH_Number(material.GWP_D1));
        }
